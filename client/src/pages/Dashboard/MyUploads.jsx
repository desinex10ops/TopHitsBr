                ...
                <>
                    <div className={styles.boostBanner}>
                        <div className={styles.boostContent}>
                            <FiTrendingUp className={styles.boostIcon} />
                            <div className={styles.boostText}>
                                <h3>Impulsione sua Carreira Artística! 🚀</h3>
                                <p>Aumente em até 10x o alcance dos seus lançamentos aparecendo no topo da Home e em playlists recomendadas.</p>
                            </div>
                        </div>
                        <button className={styles.boostActionBtn} onClick={() => window.location.href = '/dashboard/boosts'}>
                            COMEÇAR AGORA
                        </button>
                    </div>
                            ...
                            <div key={album.id} className={styles.albumCard} onClick={() => setSelectedAlbum(album)}>
                                <div className={styles.albumCoverWrapper}>
                                    ...
                                    <div className={styles.playOverlay}>
                                        <button className={styles.playAlbumBtn} onClick={(e) => { e.stopPropagation(); handlePlayAlbum(album); }}>
                                            <FiPlay />
                                        </button>
                                        <button
